...
var ReporterStats = function (_RunnableStats5) {
    (0, _inherits3.default)(ReporterStats, _RunnableStats5);

    function ReporterStats() {
        (0, _classCallCheck3.default)(this, ReporterStats);

        var _this5 = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(ReporterStats).call(this, 'base'));
            ...
            return this.failures.map(function (test) {
                ...
                try {
                    for (var _iterator = (0, _getIterator3.default)((0, _keys2.default)(test.runner)), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                        ...
                        var host = _this6.runners[pid].config.host;
                        if (host && host.indexOf('saucelabs') > -1) {
                            test.runningBrowser += '\nCheck out job at https://saucelabs.com/tests/' + _this6.runners[pid].sessionID;
                        }
                    }
                } catch (err) {
