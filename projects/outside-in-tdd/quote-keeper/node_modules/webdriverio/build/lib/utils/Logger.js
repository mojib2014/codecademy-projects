...
var Logger = function () {
    ...
    (0, _createClass3.default)(Logger, [{
        ...
        value: function debug() {
            this.write('\n');
            this.log(_constants.COLORS.yellow + 'DEBUG\t' + _constants.COLORS.reset + 'queue has stopped, you can now go into the browser');
            this.log(_constants.COLORS.yellow + 'DEBUG\t' + _constants.COLORS.dkgray + 'continue by pressing the [ENTER] key ...' + _constants.COLORS.reset);
        }
